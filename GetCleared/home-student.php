        ...
        <div id="myModal" class="modal">
          ...
          <div class="modal-content">
            ...
            <div id="feedbackdivision">
                <h3 class="text-uppercase text-success text-center fw-bolder text-warning">! ALEART !</h3>
                <p class="fw-normal fst-italic fs-5">Hi <b><?php echo $_SESSION['name'] ?></b>, Thankyou for being on <b>GetCleared</b>.</p>
                <p class="fw-normal fst-italic fs-6">GetCleared would like to inform you that we have provided a facility to Upload a profile picture for your account.</p>

                <input type="text" name="username" value="<?php echo $_SESSION['username']?>" id="user" hidden>
                <p class="fw-normal fst-italic fs-6">Please to Upload by clicking the below button.</p>

                <div class="text-center">
                    <a class="btn btn-secondary m-3" id="close">I will Upload Later</a>
                    <a class="btn btn-info" href="./profile/">Upload Profile picture</a>
                </div>
      ...
      btn_close.onclick = function(){
        modal.style.display = "none";
            ...
            $(document).ready(function(){
                ...
                $.ajax({
                    type:'get',
                    url:'./profile/getProfile.php?user='+username,
                    success: function(result){
                        console.log(result);
                        console.log(typeof(result));
                        if(result == "0"){
                            document.getElementById("myModal").style.display = "block";
                            console.log("Upload Poped");
                        }else{
