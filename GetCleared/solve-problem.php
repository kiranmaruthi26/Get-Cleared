...
if(isset($_SESSION['id']) && isset($_SESSION['fname']) && isset($_SESSION['course'])){
    ...
    <head>
        ...
        <title>Solve Problem - GetCleared</title>
    ...
    <body>
        ...
        <div class="container text-center">
            <h4 class="text-uppercase fs-3">Doubt on <?php echo $_SESSION['course'];?> course</h4>
        </div>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Doubt : <?php echo $row['id'];?></h5>
...
echo "<h5 class=text-center>You have solved everything</h5>";
}
